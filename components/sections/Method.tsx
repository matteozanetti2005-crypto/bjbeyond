...
export function Method() {
  ...
  useGSAP(
    () => {
      ...
      /* matchMedia keeps the pin off mobile and off reduced-motion entirely,
         rather than a CSS class hiding an animation that still runs. */
      ...
      mm.add(
        ...
        () => {
          ScrollTrigger.create({
            ...
            pin: true,
            /* Never pinSpacing:false — the spacer is what stops the sections
               after this one sliding underneath during the pin. */
            onUpdate: (self) => {
